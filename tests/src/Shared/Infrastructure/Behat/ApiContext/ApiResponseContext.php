...
namespace KetoFoodDbApi\Tests\Shared\Infrastructure\Behat\ApiContext;

use Behat\Gherkin\Node\PyStringNode;
use Behat\Mink\Session;
use Behat\MinkExtension\Context\RawMinkContext;
use KetoFoodDbApi\Tests\Shared\Infrastructure\Mink\MinkHelper;
use KetoFoodDbApi\Tests\Shared\Infrastructure\Mink\MinkSessionResponseHelper;
...
final class ApiResponseContext extends RawMinkContext
{
    ...
    public static function assertJsonStringEqualsJsonString($expectedJson, $actualJson, $message = ''): void
    {
        ...
        Assert::assertThat(
            $actual,
            new KetoFoodDbApiConstraintIsSimilar($expected, 20), // @todo For functional
            $message
        );
    }
